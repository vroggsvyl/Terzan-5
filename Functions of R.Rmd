...
#set initial guesses
initialGuess <- c(amplitude = 0.4, mu = 2, gamma = 1, alpha = 1)
#set bounds
...
```
plot negloglike to parameters
histo
test if it's responding to changes
take the derivative of the negative log function
numderiv - 
...
#plot(xVal, negLogLike(optimPar, xVal))
...
#set initial guesses
initialGuess <- c(amplitude = 0.4, mu = 4115, gamma = 0.4, alpha = 1)
