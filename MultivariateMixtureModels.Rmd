...
$$\frac{\delta u}{\delta \beta_1} = s_1 v_{1}^{-\beta_1} \ln(v_1) (1-\beta_1)$$
$$\frac{\delta}{\delta \beta_1} = -\sum \frac{s_1 v_{1}^{-\beta_1} \ln(v_1) (1-\beta_1)}{u}$$
Similarly for $\beta_2$
$$\frac{\delta}{\delta \beta_2} = -\sum \frac{s_2 v_{2}^{-\beta_2} \ln(v_2) (1-\beta_2)}{u}$$
